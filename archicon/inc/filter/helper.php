...
if ( ! function_exists( 'archicon_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function archicon_get_filter_items( $params ) {
		...
		return apply_filters( 'archicon_filter_get_filter_items', $items, $params );
	}
}
