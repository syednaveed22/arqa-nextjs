<div class="qodef-grid-item <?php echo esc_attr( archicon_get_page_content_sidebar_classes() ); ?>">
	...
	do_action( 'archicon_action_before_blog_loop' );
	?>
	<div class="qodef-blog qodef-m <?php echo esc_attr( archicon_get_blog_holder_classes() ); ?>">
		<?php
		// Include posts loop
		archicon_template_part( 'blog', 'templates/parts/loop' );
