...
if ( ! empty( $quote_text ) ) {
	...
	<div class="qodef-e-quote">
		<div class="quote-e-quote-title qodef-e-info">
			<span><?php echo esc_html__( 'quote', 'archicon' ); ?></span>
		</div>
		<<?php echo archicon_escape_title_tag( $title_tag ); ?> class="qodef-e-quote-text"><?php echo esc_html( $quote_text ); ?></<?php echo archicon_escape_title_tag( $title_tag ); ?>>
		<?php if ( ! empty( $quote_author ) ) { ?>
			<<?php echo archicon_escape_title_tag( $author_title_tag ); ?> class="qodef-e-quote-author"><?php echo esc_html( $quote_author ); ?></<?php echo archicon_escape_title_tag( $author_title_tag ); ?>>
		<?php } ?>
		<?php if ( ! is_single() ) { ?>
