	...
	<div class="qodef-e-inner">
		...
		<div class="qodef-e-content">
			...
			<div class="qodef-e-text">
				<?php
				// Include post title
				archicon_template_part( 'blog', 'templates/parts/post-info/title', '', array( 'title_tag' => 'h2' ) );

				// Include post excerpt
				archicon_template_part( 'blog', 'templates/parts/post-info/excerpt' );
			...
			<div class="qodef-e-bottom-holder">
				...
				archicon_template_part( 'blog', 'templates/parts/post-info/read-more' );
				?>
			</div>
		</div>
	</div>
